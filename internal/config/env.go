...
func bindings() []binding {
	return []binding{
		...
		{"VALLET_TLS_ACME_DNS_SERVER", setString(func(c *Config) *string { return &c.TLS.ACME.DNS.Server })},
		{"VALLET_TLS_ACME_DNS_TSIG_KEY_NAME", setString(func(c *Config) *string { return &c.TLS.ACME.DNS.TSIGKeyName })},
		{"VALLET_TLS_ACME_DNS_TSIG_ALGORITHM", setString(func(c *Config) *string { return &c.TLS.ACME.DNS.TSIGAlgorithm })},
		...
		{"VALLET_RETENTION_ACCESS_KEY_GRACE_SWEEP_INTERVAL", setDuration(func(c *Config) *Duration { return &c.Retention.AccessKeyGraceSweepInterval })},
		{"VALLET_RETENTION_ACCESS_KEY_GRACE_SWEEP_BATCH", setInt(func(c *Config) *int { return &c.Retention.AccessKeyGraceSweepBatch })},
