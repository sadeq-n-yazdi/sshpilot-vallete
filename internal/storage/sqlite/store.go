...
var ErrNestedTx = errors.New("sqlite: nested WithTx is not supported")
...
// Store is the SQLite unit-of-work root. It wraps a single *sql.DB whose pool
// and pragmas are configured by Open, and hands out repositories that either
...
// Admins, and OwnerSalts are populated; the remaining fields stay nil and are
...
// KeySets, Audit, Admins, and OwnerSalts — are populated; the rest are left nil
// for later slices.
